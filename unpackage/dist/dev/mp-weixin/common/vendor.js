...
/***/ 12:
/*!********************************************************************************!*\
  !*** /Users/dqgb2/Desktop/project/HBuilderProject/emos-wx/common/api/index.js ***!
  \********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 13:
/*!**********************************************************************************************!*\
  !*** /Users/dqgb2/Desktop/project/HBuilderProject/emos-wx/common/api sync nonrecursive .js$ ***!
  \**********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 14:
/*!*******************************************************************************!*\
  !*** /Users/dqgb2/Desktop/project/HBuilderProject/emos-wx/common/api/list.js ***!
  \*******************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.searchTodayCheckin = exports.validCancheckIn = exports.createFaceModel = exports.getCheckin = exports.getLogin = exports.getRegister = exports.getBaseUrl = void 0;var _http = _interopRequireDefault(__webpack_require__(/*! ../http.js */ 15));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
var getRegister = function getRegister(data) {
...
var getCheckin = function getCheckin(data) {
  return (0, _http.default)({
    url: '/checkin/checkin',
    data: data,
    method: "POST" });
...
var createFaceModel = function createFaceModel(data) {
  return (0, _http.default)({
    url: '/checkin/createFaceModel',
    data: data,
    method: "POST" });

};exports.createFaceModel = createFaceModel;

var validCancheckIn = function validCancheckIn(data) {
  return (0, _http.default)({
    url: '/checkin/validCanCheckIn',
    data: data });

};exports.validCancheckIn = validCancheckIn;

var searchTodayCheckin = function searchTodayCheckin(data) {
  return (0, _http.default)({
    url: '/checkin/searchTodayCheckin',
    data: data });

};exports.searchTodayCheckin = searchTodayCheckin;

/***/ }),

/***/ 15:
/*!***************************************************************************!*\
  !*** /Users/dqgb2/Desktop/project/HBuilderProject/emos-wx/common/http.js ***!
  \***************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = $http;exports.BASE_URL = void 0;var BASE_URL = "http://192.168.3.8:8080/emos-wx-api";
//封装通用$http1
exports.BASE_URL = BASE_URL;function $http(options) {var

  url =


  options.url,data = options.data,method = options.method;
  return new Promise(function (resolve, reject) {
    uni.request({
      url: BASE_URL + url,
      data: data,
      ...
      success: function success(resp) {
        if (resp.statusCode === 401) {
          ...
          var _data = resp.data;
          console.log("token", _data.hasOwnProperty("token"));
...
/***/ 5:
/*!***********************************************************************!*\
  !*** /Users/dqgb2/Desktop/project/HBuilderProject/emos-wx/pages.json ***!
  \***********************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 70:
/*!**************************************************************************************!*\
  !*** /Users/dqgb2/Desktop/project/HBuilderProject/emos-wx/lib/qqmap-wx-jssdk.min.js ***!
  \**************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
